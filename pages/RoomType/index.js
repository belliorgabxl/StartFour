     ...
     <div className={style.body}>
          ...
          <div className={style.container}>
               <div className={style.boxgrid}>
                    <Link href= "/RoomType/fan"className={style.boxbackground}>
                    ...
                    <Link href= "/RoomType/air" className={style.boxbackground}>
                         <div className={style.box}>
                              <div className={style.text}>
                                   ห้องพักประเภทปรับอากาศ
                              </div>
                         <div className={style.boximg}>
                    ...
                    <Link  href= "/RoomType/suite"className={style.boxbackground}>
                         <div className={style.box}>
                             <div className={style.text}>
                                  ห้องพักประเภทสวีท
                             </div>
                    ...
                    <Link href= "/RoomType/daily"className={style.boxbackground}>
                         <div className={style.box}>
                             <div className={style.text}>
                                  ห้องพักประเภทรายวัน
                             </div>
