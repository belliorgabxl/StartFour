     ...
     <div className={style.body}>
          ...
          <div className={style.container}>
               <div className={style.boxbackground}>
                    <Link href= "/RoomType/fan"className={style.boxgrid}>
               ...
               <div className={style.boxbackground}>
                   <Link href= "/RoomType/air"className={style.boxgrid}>
                         <div className={style.box}>
                              <div className={style.room1}>ประเภทห้อง</div>
                              <div className={style.room2}>ปรับอากาศ</div>
                         </div>
               ...
               <div className={style.boxbackground}>
                   <Link href= "/RoomType/suite"className={style.boxgrid}>
                         <div className={style.box}>
                              ประเภทห้องสวีท
                         </div>
                         <div className={style.slide}>
               ...
               <div className={style.boxbackground}>
                   <Link href= "/RoomType/daily"className={style.boxgrid}>
                         <div className={style.box}>
                              ประเภทห้องรายวัน
                         </div>
                         <div className={style.slide}>
