  ...
  if (user_id && user_state == "login") {
      ...
      return (
        <nav className={styles.navbar}>
          <div className={styles.topbar}>
            ...
            <span className={styles.helptab}>
              <Link href="#">{user_id}</Link>
            </span>
          ...
          <div className={styles.menubar}>
            ...
            <Link href="/#" className={styles.menulist}>
              <span>Noticfication</span>
            </Link>
            <Link href="/RoomType" className={styles.menulist}>
              <span>Roomtype</span>
            </Link>
            <Link href="/Homepage" className={styles.menulist}>
              <span>Announcment</span>
            </Link>
            <Link href="/NearMe" className={styles.menulist}>
              <span>NearMe</span>
            </Link>
            <Link href="/Homepage" className={styles.menulist}>
              <span>Promotion</span>
            </Link>
            <Link href={"/Booking/" + user_id} className={styles.menulist}>
              <span>Booking</span>
            </Link>
          </div>
        </nav>
    ...
    return (
      <nav className={styles.navbar}>
        ...
        <div className={styles.menubar}>
          <div className={styles.dropdown}>
            <Image src="/dropdown.png" alt="dropdown" width={45} height={45} />
          ...
          <Link href="/AboutUs" className={styles.menulist}>
            <span>Aboute Us</span>
          </Link>
        </div>
      </nav>
